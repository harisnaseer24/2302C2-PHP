...
function sendRecoveryLink($token, $email,$username){
    ...
    try {
        ...
        $mail->Password   = 'yjsi itqy alep srqx';                               //SMTP password
        ...
        $mail->Body    = 'A request has been generated to reset your password. Please <b><a href="http://localhost:82/2302C2%20php/login/resetpass.php?token='.$token.'&email='.$email.'">Click here</a></b> to reset your password.';
